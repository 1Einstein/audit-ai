...
export default async function AuditPage({
  ...
  const { username } = await searchParams; // Next.js 15 Promise fix
  ...
  if (targetUser) {
    try {
      // Fixed 400 Error: Using 'handle' parameter for V2
  ...
  // Proper data mapping to fix "0 Followers"
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[32px] shadow-xl">
                <Activity className="text-green-500 w-5 h-5 mb-4" /> {/* Capitalized fix */}
